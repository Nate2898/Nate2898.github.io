document.addEventListener('DOMContentLoaded', () => {
    ...
    //     if (event.target.tagName === 'B' || event.target.closest('b')) {
    //         document.getElementById('bold').style.backgroundColor = 'rgb(255, 0, 0)';
    //     }
...
//     bold.style.backgroundColor = 'rgb(255, 255, 255)';
//     return;
//     }
    
//     bold.style.backgroundColor = 'rgb(255, 0, 0)';
// });
...
async function deleteNote(noteId) {
    try {
        ...
        if (currentNoteId === noteId) {
            window.location.href = '../'; //takes the user back to the index page
        }
